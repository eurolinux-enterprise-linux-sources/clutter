...
extern const char cogl_fixed_fragment_shader_variables_start[];
extern const char cogl_fixed_fragment_shader_inputs[];
extern const char cogl_fixed_fragment_shader_texturing_options[];
extern const char cogl_fixed_fragment_shader_fogging_options[];
extern const char cogl_fixed_fragment_shader_main_declare[];
extern const char cogl_fixed_fragment_shader_main_start[];
